...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-tidypredict-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-tidypredict-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-tidypredict
# for installing globally
pixi global install r-tidypredict
```
...
It is possible to list all of the versions of `r-tidypredict` available on your platform:
...
```
pixi search r-tidypredict --channel conda-forge
```
